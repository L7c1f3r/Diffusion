...
def main():
    ...
    outpaths = [os.path.join(f"{exp_path_root}/{exp_config.source_experiment_name}/translations", f"{exp_config.scale}_ALLCON_{translation_folder}") for translation_folder in translation_folders]
    ...
    print(f"ALL_Controled_PnP results saved in: {'; '.join(outpaths)}")
